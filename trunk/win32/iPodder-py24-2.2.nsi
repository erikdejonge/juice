; NSI file for python 2.4 only.
;
; $Id: iPodder-py24-2.2.nsi,v 1.3 2005/09/19 03:54:36 sgrayban Exp $
;
...
; Used for Windows version checking.
!include "General.nsh"

Name "${PRODUCT_NAME} ${PRODUCT_VERSION}"
OutFile "iPodder-python24-2.2a2Setup.exe"
...
;;  File "..\dist\_winreg.pyd"
  ...
  File "..\dist\docs\iPodderUserGuide.pdf"
  File "..\dist\docs\iPodderUserGuide.html"
  File "..\dist\docs\iPodderUserGuide.txt"
SectionEnd
...
;;  Delete "$INSTDIR\_sre.pyd"
  ...
  Delete "$INSTDIR\pythoncom24.dll"
...
;;  Delete "$INSTDIR\datetime.pyd"
  ...
  Delete "$INSTDIR\docs\iPodderUserGuide.pdf"
  Delete "$INSTDIR\docs\iPodderUserGuide.html"
  Delete "$INSTDIR\docs\iPodderUserGuide.txt"
