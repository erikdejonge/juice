# from http://nsis.sourceforge.net/Talk:Uninstall_only_installed_files
# thanks to adrian dot neagu at scansoft dot com
...
inst_file_tpl = '  File ..\dist%s'
uninst_file_tpl = '  Delete $INSTDIR%s'
uninst_pyc_file_tpl = '  Delete $INSTDIR%sc'
...
print >> ih,  "  ; Automatically generated by genInstallList.py\n"
print >> uh,  "  ; Files and dirs to remove\n"
print >> uh,  "  ; Automatically generated by genInstallList.py\n"
...
for (my_files, my_dir) in stack_of_visited:
        for f in my_files:
            ...
            if f[-3:] == ".py":
                print >> uh, uninst_pyc_file_tpl % (my_dir+os.sep+f)
        if my_dir != "\\.": print >> uh, uninst_dir_tpl % my_dir
        print >> uh, "  "
